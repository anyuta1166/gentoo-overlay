...
SNAP_REV="r21b56a0bc1b9c8c9ff2e2905ef3a0f6437505a27-305"
MY_P=${PN}-${PV%_p*}

DESCRIPTION="Network-UPS Tools"
HOMEPAGE="http://www.networkupstools.org/"
# Nut mirrors are presently broken
SRC_URI="http://buildbot.networkupstools.org/~buildbot/cayman/snapshot/master/${SNAP_REV}/${MY_P}.tar.gz"
...
src_prepare() {
	...
	sed -e "s:62.nut-usbups.rules:70-nut-usbups.rules:" \
